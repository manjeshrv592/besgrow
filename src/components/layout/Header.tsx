...
const Header = ({ productsHref = "/products", locale }: HeaderProps) => {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 z-50 flex w-full items-center px-4 transition-all duration-300 ease-in-out ${
      ...
      >
        ...
        <Container className="flex-1">
          ...
          <div className="flex justify-end gap-10 lg:justify-start">
            ...
            <div className="lg:flex lg:basis-[calc(30%-48px)] lg:justify-center">
